...
def upload_csv(request):
    ...
    expected_columns = ['card_id', 'admission_no', 'name', 'dob', 'department', 'level', 'phone', 'sex', 'email', 'address']
            ...
            if csv_file.name.endswith('.csv'):
                ...
                for row in csv_data:
                    ...
                    for col in expected_columns:
                        if col not in row:
                            row[col] = ''  # Fill missing columns with blank values
